...
/**************************************************************************/
/*! 
    @brief  Configures to INA219 to be able to measure up to 32V and 30A
            of current.  Each unit of current corresponds to 1000uA, and
            each unit of power corresponds to 20mW. Counter overflow
            occurs at 32.7A.
			
    @note   These calculations assume a 0.0025 ohm resistor is present
*/
/**************************************************************************/
void Adafruit_INA219::ina219SetCalibration_32V_30A(void)
{
  //Notes by JAL, this section was written originally for 32V 2A.
  //JAL changed to 32V 30A used external shunt 30A 75mV .0025 ohm.
  //JAL you must remove the .1 ohm resistor from the INA219 board.
  ...
  // RSHUNT = 0.0025               (Resistor value in ohms)
  ...
  // MinimumLSB = 0.0009155             (920uA per bit)
  // MaximumLSB = MaxExpected_I/4096
  // MaximumLSB = 0,0073242             (4888uA per bit)
...
/*void Adafruit_INA219::setCalibration_32V_30A(void)
{

  ina219_calValue = 15604;
  ina219_currentDivider_mA = 1;
  ina219_powerDivider_mW = .1;
  wireWriteRegister(INA219_REG_CALIBRATION, ina219_calValue);
